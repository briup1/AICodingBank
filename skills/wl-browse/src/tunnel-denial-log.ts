 ...
 * - Writes to ~/.local/state/wl-ai-skills/browse/security/attempts.jsonl, shared with the prompt-injection
...
const LOG_DIR = path.join(os.homedir(), '.local', 'state', 'wl-ai-skills', 'browse', 'security');
