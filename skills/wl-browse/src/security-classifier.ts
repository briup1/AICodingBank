 ...
 * layout at ~/.local/state/wl-ai-skills/browse/models/testsavant-small/ on first use.
 *
 ...
 */
const MODELS_DIR = path.join(os.homedir(), '.local', 'state', 'wl-ai-skills', 'browse', 'models');
