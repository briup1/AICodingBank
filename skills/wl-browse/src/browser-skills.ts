 ...
 *   global:   ~/.local/state/wl-ai-skills/browse/browser-skills/<name>/
...
export function defaultTierPaths(opts: { projectRoot?: string; home?: string; bundledRoot?: string } = {}): TierPaths {
  ...
  return {
    project: projectRoot ? path.join(projectRoot, '.wl-ai-skills', 'browse', 'browser-skills') : null,
    global: path.join(home, '.local', 'state', 'wl-ai-skills', 'browse', 'browser-skills'),
