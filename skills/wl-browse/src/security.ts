 ...
 *
 * Cross-process state lives at ~/.local/state/wl-ai-skills/browse/security/session-state.json
...
const SECURITY_DIR = path.join(os.homedir(), '.local', 'state', 'wl-ai-skills', 'browse', 'security');
 ...
 * ~/.local/state/wl-ai-skills/browse/security/device-salt (0600). Random per-device, prevents rainbow
...
// per-tab file under ~/.local/state/wl-ai-skills/browse/security/decisions/, sidebar-agent polls
