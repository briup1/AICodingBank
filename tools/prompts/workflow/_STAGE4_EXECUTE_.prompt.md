---
title: "Stage4 Execute .prompt"
date: 2026-06-21
category: prompts
tags: []
status: published
description: "Notes on Stage4 Execute .prompt."
---
...
3. **遵循设计文档**
   - 严格遵守技术方案tech_design.md和prd.md文档
   - 避免设计冲突和不一致
   - **完成开发后反思开发成果是否与设计文档一致**
...
任务已完成，请确认：
- 回复 "确认" 或 "confirm" 更新任务清单任务状态为完成并且继续下一个任务
